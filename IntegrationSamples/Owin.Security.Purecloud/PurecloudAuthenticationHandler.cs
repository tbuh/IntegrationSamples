...
{
    internal class PurecloudAuthenticationHandler : AuthenticationHandler<PurecloudAuthenticationOptions>
    {
        private const string XmlSchemaString = "http://www.w3.org/2001/XMLSchema#string";

        private readonly ILogger _logger;
        private readonly HttpClient _httpClient;
        private const string StateCookie = "__PurecloudState";

        public PurecloudAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            if (Options.CallbackPath.HasValue && Options.CallbackPath == Request.Path)
            {
                ...
                var context = new PurecloudReturnEndpointContext(Context, ticket);
